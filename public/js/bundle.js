...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"view/baseView.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.searchResults = exports.validateInput = exports.validateInputs = exports.validatePasswordInput = exports.checkPasswordMatch = exports.checkDeliveryOnPincode = exports.toggleShowPassword = exports.changeResponsiveContent = exports.renderMobileNav = exports.variables = exports.DOMElements = void 0;
...
var DOMElements = {
  ...
  toggleBtnPassword: Array.from(document.querySelectorAll('.password__toggleBtn')),
  // AddressObj DOM
  addressInfo: {
  ...
  addressInfoValue: {},
  deleteAddressBtn: Array.from(document.querySelectorAll('.myAddress__btnDelete')),
  ...
  quantityData: Array.from(document.querySelectorAll('.cart__info--quantity__data')),
  ...
  //Pincode
  pincodeCheckBtn: document.querySelector('.product__info__basic__pincode__checkBtn'),
  pincodeCheckInput: document.querySelector('.product__info__basic__pincode__input'),
...
var removeMobileNav = function removeMobileNav() {
  DOMElements.mobileNavObj.classList.remove('modalNav__show');
};

var renderMobileNav = function renderMobileNav() {
  document.querySelector(".navigation__primary__item--menuBtn").addEventListener('click', showMobileNav);
  document.querySelector('.modalNav__close').addEventListener('click', removeMobileNav);
};
/* ########### */
// Again make the transition availabe after load


exports.renderMobileNav = renderMobileNav;
...
window.addEventListener('click', function (e) {
  if (!(e.target.matches('.modalNav__content') || e.target.matches(".modalNav__content *") || e.target.matches(".navigation__primary__item--menuBtn") || e.target.matches(".navigation__primary__item--menuBtn *"))) removeMobileNav();
});
/*---- FOR CHANGING THE IMAGES AND REQUIRED DATA ON RESIZE ----*/

var changeResponsiveContent = function changeResponsiveContent() {
  if (DOMElements.browserWidth <= 700) {
    if (DOMElements.headerImg) {
      DOMElements.headerImg.setAttribute('src', './images/home_page/home_top_header_mobile.jpg');
    }

    if (DOMElements.droneImg) {
      DOMElements.droneImg.setAttribute('src', './images/home_page/home_drone_mobile.jpg');
    }
  } else if (DOMElements.browserWidth >= 1200) {
    if (DOMElements.headerImg) {
      DOMElements.headerImg.setAttribute('src', './images/home_page/home_top_header.jpg');
    }

    if (DOMElements.droneImg) {
      DOMElements.droneImg.setAttribute('src', './images/home_page/home_drone.jpg');
    }
  }
};
/* ########### */
...
exports.changeResponsiveContent = changeResponsiveContent;

var toggleShowPassword = function toggleShowPassword(e) {
  var pass = document.querySelector(".form__field__password input");
...
if (DOMElements.bookingDetailsQuantity) {
  if (DOMElements.bookingDetailsTotal.textContent === '') {
    DOMElements.bookingDetailsQuantity.textContent = "Quantity : ".concat(sessionStorage.getItem('buyingQuantity'));
    DOMElements.bookingDetailsTotal.textContent = "\u20B9 ".concat(Number(DOMElements.bookingDetailsItemPrice.textContent.match(/(\d+)/)[0]) * Number(sessionStorage.getItem('buyingQuantity')), " /-"); // Multiplying Item price with quantity
  }
}

var checkDeliveryOnPincode = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var pincode, res, markUpPincode;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            pincode = Number(DOMElements.pincodeCheckInput.value);
            _context.next = 3;
            return (0, _axios.default)({
              method: 'GET',
              url: "https://api.postalpincode.in/pincode/".concat(pincode)
            });

          case 3:
            res = _context.sent;

            markUpPincode = function markUpPincode(msg) {
              var error = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;

              if (document.querySelector('.pincode__notice')) {
                document.querySelector('.pincode__notice').parentNode.removeChild(document.querySelector('.pincode__notice'));
              }

              var markUp = "\n    <tr class = \"pincode__notice \">\n      <td></td>\n      <td><div class = ".concat(error === false ? 'small__para--success' : 'small__para--error', ">").concat(msg, "</div></td>\n    </tr>");
              document.querySelector('.pincodeDeliveryRow').insertAdjacentHTML('afterend', markUp);
            };
          ...
          case 8:
            if (res.data[0].Status === 'Success' && res.data[0].PostOffice[0].State === 'Maharashtra') {
              markUpPincode("Delivery within 2-3 days at your pincode ".concat(pincode));
            } else {
              markUpPincode("Delivery is not available at your pincode ".concat(pincode), true);
            }
  ...
  return function checkDeliveryOnPincode() {
    return _ref.apply(this, arguments);
  };
}(); // Validations


exports.checkDeliveryOnPincode = checkDeliveryOnPincode;

var formInputErrorNotice = function formInputErrorNotice() {
  ...
  if (msg === '') return;
  var markUp = "\n         <div class = 'para--small color--error formInput__error u-margin-top-extraSmall'>".concat(msg, "</div>\n    ");
...
var validatePasswordInput = function validatePasswordInput(passwordObj) {
  return function () {
    if (passwordObj.value.length < 6) {
      formInputErrorNotice(passwordObj, 'Password should be of minimum 6 characters');
    } else {
...
var validateInputs = function validateInputs() {
  for (var i = 0; i < DOMElements.inputCommonArr.length; i++) {
    if (DOMElements.inputCommonArr[i].value.length < 1) {
      formInputErrorNotice(DOMElements.inputCommonArr[i], 'This field is mondatory');
      return false;
    }
  }
...
var searchResults = function searchResults() {
  location.assign("/search/?searchStr=".concat(DOMElements.searchInput.value));
};

exports.searchResults = searchResults;
},{"axios":"../../node_modules/axios/index.js"}],"view/customAlerts.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.alertSecondary = exports.alertPrimary = void 0;

// Promises
var alertPrimary = function alertPrimary(type, msg) {
  var alertMarkup = "\n  <div class = 'customAlert customAlert--".concat(type, "'>\n  ").concat(msg, "\n  </div>");
  document.querySelector('body').insertAdjacentHTML('beforeend', alertMarkup);
  return new Promise(function (resolve, reject) {
    window.setTimeout(function () {
      var alertEl = document.querySelector('.customAlert');
...
exports.alertPrimary = alertPrimary;

var alertSecondary = function alertSecondary(msg) {
  var alertMarkup = "\n      <div class = \"modalAlert\">\n          <div class = \"modalAlert__content\">\n              <div class = \"modalAlert__para\">\n                  ".concat(msg, "\n              </div>\n              <a class = \"modalAlert__btn--ok\">Ok</a>\n          </div>\n      </div>\n        ");
  document.querySelector('body').insertAdjacentHTML('beforeend', alertMarkup);
  document.querySelector('.modalAlert__btn--ok').addEventListener('click', function () {
    document.querySelector('.modalAlert').parentElement.removeChild(document.querySelector('.modalAlert'));
  });
};

exports.alertSecondary = alertSecondary;
},{}],"model/BookingProduct.js":[function(require,module,exports) {
"use strict";
...
// This Class is used to create objects of booking > product type
var BookingProduct = function BookingProduct(productId, quantity) {
  _classCallCheck(this, BookingProduct);

  this.productId = productId;
  this.quantity = quantity;
};

exports.default = BookingProduct;
},{}],"model/CartProduct.js":[function(require,module,exports) {
"use strict";
...
var CartProduct = function CartProduct(product, quantity) {
...
},{}],"controller/utilities.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.renderAlertSecondary = exports.renderAlertPrimary = exports.getCookie = exports.createCookie = void 0;

var customAlerts = _interopRequireWildcard(require("../view/customAlerts"));
...
var renderAlertPrimary = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(res, msg) {
    var reload,
        assign,
        _args = arguments;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            reload = _args.length > 2 && _args[2] !== undefined ? _args[2] : false;
            assign = _args.length > 3 && _args[3] !== undefined ? _args[3] : '/';
            ...
            _context.next = 5;
            return customAlerts.alertPrimary('success', msg);
  ...
  return function renderAlertPrimary(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}(); // ## For Showing the Alert Secondary


exports.renderAlertPrimary = renderAlertPrimary;

var renderAlertSecondary = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(msg, reload) {
    var assign,
        _args2 = arguments;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            assign = _args2.length > 2 && _args2[2] !== undefined ? _args2[2] : '';
  ...
  return function renderAlertSecondary(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

exports.renderAlertSecondary = renderAlertSecondary;
},{"../view/customAlerts":"view/customAlerts.js"}],"controller/authenticate.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.cancelOrder = exports.proceedToBookingDetails = exports.addProductToBooking = exports.updateProductCart = exports.removeCartItem = exports.addProductToCart = exports.resetPassword = exports.forgetPassword = exports.deleteAddress = exports.updateAddress = exports.addAddress = exports.changePassword = exports.updateProfile = exports.signup = exports.logout = exports.login = void 0;

var _axios = _interopRequireDefault(require("axios"));

var customAlerts = _interopRequireWildcard(require("../view/customAlerts"));

var baseView = _interopRequireWildcard(require("../view/baseView"));

var _BookingProduct = _interopRequireDefault(require("../model/BookingProduct"));

var _CartProduct = _interopRequireDefault(require("../model/CartProduct"));
...
var ipAddr = baseView.variables.computerIp;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(email, password) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            st = _args.length > 2 && _args[2] !== undefined ? _args[2] : '';
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'POST',
              url: "http://".concat(ipAddr, ":2000/api/v1/users/login"),
              data: {
                email: email,
                password: password
              }
          ...
          case 4:
            ...
            if (st === 'booking') {
              ...
              if (res.data.status === 'error' && res.data.issue === 'emailNotConfirmed') {
                ...
                customAlerts.alertSecondary("We've sent you a email!!! Please confirm it to activate your account!!");
              } else {
          ...
          case 8:
            ...
            utilities.renderAlertSecondary(_context.t0.response.data.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://".concat(ipAddr, ":2000/api/v1/users/logout")
            });
          ...
          case 7:
            ...
            utilities.renderAlertSecondary(_context2.t0.response.data.message);
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            st = _args3.length > 4 && _args3[4] !== undefined ? _args3[4] : '';
            _context3.prev = 1;
            _context3.next = 4;
            return (0, _axios.default)({
              method: 'POST',
              url: "http://".concat(ipAddr, ":2000/api/v1/users/signup"),
              data: {
                name: name,
                email: email,
                password: password,
          ...
          case 4:
            ...
            if (st === 'booking') {
              redirectUrl = window.location.pathname.replace('/signup', ''); // Get Back to the booking process after signup

              utilities.renderAlertPrimary(res, 'Account created successfully!!', false, redirectUrl);
            }
          ...
          case 9:
            ...
            utilities.renderAlertSecondary(_context3.t0.response.data.message);
...
var updateProfile = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(name, email) {
    var res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://".concat(ipAddr, ":2000/api/v1/users/updateMe"),
              data: {
                name: name,
                email: email
              }
          ...
          case 7:
            ...
            utilities.renderAlertSecondary(_context4.t0.response.data.message);
...
var changePassword = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(currentPassword, newPassword, confirmPassword) {
    var res;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://".concat(ipAddr, ":2000/api/v1/users/changePassword"),
              data: {
          ...
          case 7:
            ...
            utilities.renderAlertSecondary(_context5.t0.response.data.message);
...
var resAddEditAddress = function resAddEditAddress(res, st, msg) {
  // If the user is trying to edit or add the adddress while booking,, so redirect him again after updating
  if (st === 'booking') {
    utilities.renderAlertPrimary(res, msg, false, sessionStorage.getItem('chooseAddressRoute'));
  } else {
...
var addAddress = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(addressInfo) {
    var st,
        res,
        _args6 = arguments;
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            st = _args6.length > 1 && _args6[1] !== undefined ? _args6[1] : '';
            _context6.prev = 1;
            _context6.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://".concat(ipAddr, ":2000/api/v1/users/addAddress"),
              data: {
          ...
          case 8:
            ...
            utilities.renderAlertSecondary(_context6.t0.response.data.message);
  ...
  return function addAddress(_x12) {
...
var updateAddress = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(addressInfo, id) {
    var st,
        res,
        _args7 = arguments;
    return regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            st = _args7.length > 2 && _args7[2] !== undefined ? _args7[2] : '';
            _context7.prev = 1;
            _context7.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://".concat(ipAddr, ":2000/api/v1/users/updateAddress/").concat(id),
              data: {
                addressInfo: addressInfo
              }
            });
          ...
          case 8:
            ...
            utilities.renderAlertSecondary(_context7.t0.response.data.message);
...
var deleteAddress = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://".concat(ipAddr, ":2000/api/v1/users/deleteAddress/").concat(id)
            });
          ...
          case 7:
            ...
            utilities.renderAlertSecondary(_context8.t0.response.data.message);
  ...
  return function deleteAddress(_x15) {
...
var forgetPassword = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://".concat(ipAddr, ":2000/api/v1/users/forgetPassword"),
              data: {
                email: email
              }
            });
          ...
          case 3:
            res = _context9.sent;
            utilities.renderAlertSecondary('A instruction has sent to your email for reseting your password!');
            _context9.next = 9;
            break;
  ...
  return function forgetPassword(_x16) {
...
var resetPassword = /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(password, passwordConfirm, resetToken) {
    var res;
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://".concat(ipAddr, ":2000/api/v1/users/resetPassword/").concat(resetToken),
              data: {
                password: password,
                passwordConfirm: passwordConfirm
              }
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              utilities.renderAlertSecondary('Password Resetted successfully', false, '/');
            }
          ...
          case 7:
            ...
            utilities.renderAlertSecondary(_context10.t0.response.data.message);
  ...
  return function resetPassword(_x17, _x18, _x19) {
...
var addProductToCart = /*#__PURE__*/function () {
  var _ref11 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(product, quantity) {
    var res, cartItem, i, cart, l;
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://".concat(ipAddr, ":2000/api/v1/users/product/addToCart"),
              data: {
                product: product,
                quantity: quantity
              }
          ...
          case 8:
            if (!(baseView.DOMElements.navigation.dataset.user === 'false')) {
              _context11.next = 32;
              break;
            }
            ...
            cartItem = new _CartProduct.default(product, quantity);
            cart = [];
          ...
          case 34:
            ...
            customAlerts.alertPrimary('error', _context11.t0.response.data.message, true);
  ...
  return function addProductToCart(_x20, _x21) {
...
var removeCartItem = /*#__PURE__*/function () {
  var _ref12 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(product) {
    var res, cart, i, del;
      ...
      while (1) {
        switch (_context12.prev = _context12.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://".concat(ipAddr, ":2000/api/v1/users/product/deleteFromCart"),
              data: {
                product: product
              }
            });
          ...
          case 23:
            ...
            utilities.renderAlertSecondary(_context12.t0.response.data.message);
  ...
  return function removeCartItem(_x22) {
...
var updateProductCart = /*#__PURE__*/function () {
  var _ref13 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(product, quantity) {
    var cart, i;
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://".concat(ipAddr, ":2000/api/v1/users/product/updateProductCart/").concat(product),
              data: {
                quantity: quantity
              }
            });
          ...
          case 20:
            ...
            utilities.renderAlertSecondary(_context13.t0.response.data.message);
  ...
  return function updateProductCart(_x23, _x24) {
...
var addProductToBooking = /*#__PURE__*/function () {
  var _ref14 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(userId) {
    var productId,
        cartRes,
        product,
        i,
    ...
    return regeneratorRuntime.wrap(function _callee14$(_context14) {
      while (1) {
        switch (_context14.prev = _context14.next) {
          case 0:
            productId = _args14.length > 1 && _args14[1] !== undefined ? _args14[1] : null;
            _context14.prev = 1;
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://".concat(ipAddr, ":2000/api/v1/users/getCartProducts")
            });

          case 5:
            cartRes = _context14.sent;
            product = [];

            for (i = 0; i < cartRes.data.cart.length; i++) {
              product[i] = new _BookingProduct.default(cartRes.data.cart[i].product, cartRes.data.cart[i].quantity);
            }

            _context14.next = 10;
            return (0, _axios.default)({
              method: 'POST',
              url: "http://".concat(ipAddr, ":2000/api/v1/users/").concat(userId, "/bookings"),
              data: {
                product: product
              }
            });
          ...
          case 10:
            res = _context14.sent;
            utilities.renderAlertPrimary(res, 'Congratulation!!, Your booking has been confirmed.');
            _context14.next = 19;
            break;

          case 14:
            _product = new _BookingProduct.default(productId, Number(sessionStorage.getItem('buyingQuantity')));
            _context14.next = 17;
            return (0, _axios.default)({
              method: 'POST',
              url: "http://".concat(ipAddr, ":2000/api/v1/users/").concat(userId, "/bookings"),
          ...
          case 21:
            ...
            utilities.renderAlertSecondary(_context14.t0.response.data.message);
  ...
  return function addProductToBooking(_x25) {
    return _ref14.apply(this, arguments);
  };
}(); // After selecting the Address


exports.addProductToBooking = addProductToBooking;

var proceedToBookingDetails = function proceedToBookingDetails() {
  var addrArrIndex, nextRoute; // Fetching the pathName from url ,, and removing the chooseAddress will make the route required for bookingsDetails

  baseView.DOMElements.radioBtnAddress.forEach(function (el) {
    if (el.checked) {
  ...
  if (window.location.pathname.search('chooseAddress/' != -1)) {
    ...
    nextRoute = nextRoute + "/".concat(addrArrIndex);
  } else {
    nextRoute = window.location.pathname.replace('chooseAddress', '');
    nextRoute = nextRoute + "".concat(addrArrIndex);
  }

  window.location.assign("".concat(nextRoute));
}; // Cancel Order


exports.proceedToBookingDetails = proceedToBookingDetails;

var cancelOrder = function cancelOrder(orderId, userId) {
      ...
      while (1) {
        switch (_context15.prev = _context15.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://".concat(ipAddr, ":2000/api/v1/users/").concat(userId, "/bookings/").concat(orderId),
              data: {
                status: 'cancelled'
              }
            });
          ...
          case 7:
            ...
            utilities.renderAlertSecondary(_context15.t0.response.data.message);
...
},{"axios":"../../node_modules/axios/index.js","../view/customAlerts":"view/customAlerts.js","../view/baseView":"view/baseView.js","../model/BookingProduct":"model/BookingProduct.js","../model/CartProduct":"model/CartProduct.js","./utilities":"controller/utilities.js"}],"view/cartView.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showCart = exports.updateCart = void 0;

var baseView = _interopRequireWildcard(require("./baseView"));

var authenticate = _interopRequireWildcard(require("../controller/authenticate"));

var _axios = _interopRequireDefault(require("axios"));

var utilities = _interopRequireWildcard(require("../controller/utilities"));
...
var isMobile = /Android/i.test(navigator.userAgent);
var ipAddr = baseView.variables.computerIp;
if (isMobile === true) ipAddr = baseView.variables.mobileIp; // Updating the total cart Price of cart

var updateCartTotalPrice = function updateCartTotalPrice(exAmt, st) {
  var tPrice = Number(baseView.DOMElements.totalAmtCart.textContent.match(/(\d+)/)[0]);

  if (st === 'add') {
    baseView.DOMElements.totalAmtCart.textContent = "\u20B9 ".concat(tPrice + exAmt, " /-");
  } else if (st === 'minus') {
    baseView.DOMElements.totalAmtCart.textContent = "\u20B9 ".concat(tPrice - exAmt, " /-");
  }
...
var updateCart = function updateCart(i) {
  return function (e) {
    if (e.target.matches('.cart__info--quantity__plus')) {
      baseView.DOMElements.quantityData[i].textContent = Number(baseView.DOMElements.quantityData[i].textContent) + 1;
      updateCartTotalPrice(Number(baseView.DOMElements.cartItemsPrice[i].textContent.match(/(\d+)/)[0]), // Regex to match a number in a string
      'add');
    } else if (e.target.matches('.cart__info--quantity__minus')) {
      if (Number(baseView.DOMElements.quantityData[i].textContent) > 1) {
        baseView.DOMElements.quantityData[i].textContent = Number(baseView.DOMElements.quantityData[i].textContent) - 1;
        updateCartTotalPrice(Number(baseView.DOMElements.cartItemsPrice[i].textContent.match(/(\d+)/)[0]), 'minus');
      }
    } // Save the Updated Quantity to database or the cookie


    authenticate.updateProductCart(baseView.DOMElements.removeCartItemBtn[i].dataset.productid, Number(baseView.DOMElements.quantityData[i].textContent), true);
  };
};
/* ########### */
// Show Cart
...
var showCart = function showCart(user) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            window.location.assign("/myAccount/cart/".concat(user));
            _context.next = 7;
            break;
          ...
          case 4:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://".concat(ipAddr, ":2000/myAccount/cart")
            });
...
},{"./baseView":"view/baseView.js","../controller/authenticate":"controller/authenticate.js","axios":"../../node_modules/axios/index.js","../controller/utilities":"controller/utilities.js"}],"main.js":[function(require,module,exports) {
"use strict";
...
var cartView = _interopRequireWildcard(require("./view/cartView"));
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  if (baseView.DOMElements.toggleBtnPassword) {
    baseView.DOMElements.toggleBtnPassword.forEach(function (el) {
      el.addEventListener('click', baseView.toggleShowPassword);
    });
  }

  if (baseView.DOMElements.cartItems) {
    for (var i = 0; i < baseView.DOMElements.cartItems.length; i++) {
      baseView.DOMElements.cartItems[i].addEventListener('click', cartView.updateCart(i));
    }
  }
});
/* ###### */
...
var assignAddressDOM = function assignAddressDOM() {
  baseView.DOMElements.addressInfoValue.name = baseView.DOMElements.addressInfo.name.value;
  baseView.DOMElements.addressInfoValue.mobileNo = baseView.DOMElements.addressInfo.mobileNo.value;
  baseView.DOMElements.addressInfoValue.houseNo = baseView.DOMElements.addressInfo.houseNo.value;
  baseView.DOMElements.addressInfoValue.street = baseView.DOMElements.addressInfo.street.value;
  baseView.DOMElements.addressInfoValue.locality = baseView.DOMElements.addressInfo.locality.value;
  baseView.DOMElements.addressInfoValue.city = baseView.DOMElements.addressInfo.city.value;
  baseView.DOMElements.addressInfoValue.pincode = baseView.DOMElements.addressInfo.pincode.value;
  baseView.DOMElements.addressInfoValue.district = baseView.DOMElements.addressInfo.district.value;
  baseView.DOMElements.addressInfoValue.state = baseView.DOMElements.addressInfo.state.value;
  baseView.DOMElements.addressInfoValue.country = baseView.DOMElements.addressInfo.country.value;
};
/* ###### */
...
if (baseView.DOMElements.formLogin) {
  baseView.DOMElements.formLogin.addEventListener('submit', function (e) {
    e.preventDefault();

    if (baseView.validateInputs()) {
      authenticate.login(baseView.DOMElements.email.value, baseView.DOMElements.password.value, baseView.DOMElements.formLogin.dataset.status);
    }
  });
}
/* ###### */
...
if (baseView.DOMElements.formSignup) {
  baseView.DOMElements.formSignup.addEventListener('submit', function (e) {
    e.preventDefault();

    if (baseView.validateInputs()) {
      authenticate.signup(baseView.DOMElements.fullName.value, baseView.DOMElements.email.value, baseView.DOMElements.newPassword.value, baseView.DOMElements.confirmPassword.value, baseView.DOMElements.formSignup.dataset.status);
    }
  });
}
/* ###### */
...
if (baseView.DOMElements.formUpdateProfile) {
  baseView.DOMElements.formUpdateProfile.addEventListener('submit', function (e) {
    e.preventDefault();

    if (baseView.validateInputs()) {
      authenticate.updateProfile(baseView.DOMElements.fullName.value, baseView.DOMElements.email.value);
    }
  });
}
/* ###### */
...
if (baseView.DOMElements.formChangePassword) {
  baseView.DOMElements.formChangePassword.addEventListener('submit', function (e) {
    e.preventDefault();

    if (baseView.validateInputs()) {
      authenticate.changePassword(baseView.DOMElements.currentPassword.value, baseView.DOMElements.newPassword.value, baseView.DOMElements.confirmPassword.value);
    }
  });
}
/* ###### */
...
if (baseView.DOMElements.addressInfo.pincode) {
  baseView.DOMElements.addressInfo.pincode.addEventListener('change', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(el) {
      var pinCodeRes, dataObj;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return (0, _axios.default)({
                method: 'GET',
                url: "https://api.postalpincode.in/pincode/".concat(parseInt(baseView.DOMElements.addressInfo.pincode.value))
              });

            case 2:
              pinCodeRes = _context.sent;
...
if (baseView.DOMElements.formAddAddress) {
  baseView.DOMElements.formAddAddress.addEventListener('submit', function (e) {
    e.preventDefault();
    assignAddressDOM();

    if (baseView.validateInputs()) {
      authenticate.addAddress(baseView.DOMElements.addressInfoValue, baseView.DOMElements.formAddAddress.dataset.status);
    }
  });
}
/* ###### */
...
if (baseView.DOMElements.formUpdateAddress) {
  baseView.DOMElements.formUpdateAddress.addEventListener('submit', function (e) {
    e.preventDefault();
    assignAddressDOM();

    if (baseView.validateInputs()) {
      authenticate.updateAddress(baseView.DOMElements.addressInfoValue, baseView.DOMElements.formUpdateAddress.dataset.addressid, baseView.DOMElements.formUpdateAddress.dataset.status);
    }
  });
}
/* ###### */
...
if (baseView.DOMElements.deleteAddressBtn.length > 0) {
  baseView.DOMElements.deleteAddressBtn.forEach(function (el) {
    return el.addEventListener('click', function (e) {
      authenticate.deleteAddress(el.dataset.addressid); // Here u can user el. ,, because el is the element which is coming for, loop not from eventListener
    });
  });
}
/* ###### */
...
if (baseView.DOMElements.addToCartBtn) {
  baseView.DOMElements.addToCartBtn.addEventListener('click', function (e) {
    authenticate.addProductToCart(baseView.DOMElements.addToCartBtn.dataset.productid, baseView.DOMElements.productQuantityCart.value);
  });
}
/* ###### */
...
if (baseView.DOMElements.removeCartItemBtn) {
  baseView.DOMElements.removeCartItemBtn.forEach(function (el) {
...
if (baseView.DOMElements.formPasswordForgot) {
  baseView.DOMElements.formPasswordForgot.addEventListener('submit', function (e) {
    e.preventDefault();
...
if (baseView.DOMElements.formPasswordReset) {
  baseView.DOMElements.formPasswordReset.addEventListener('submit', function (e) {
    e.preventDefault();

    if (baseView.validateInputs()) {
      authenticate.resetPassword(baseView.DOMElements.newPassword.value, baseView.DOMElements.confirmPassword.value, baseView.DOMElements.formPasswordReset.dataset.resettoken);
    }
  });
...
if (baseView.DOMElements.buyNowBtn) {
  baseView.DOMElements.buyNowBtn.addEventListener('click', function () {
    sessionStorage.setItem('buyingQuantity', baseView.DOMElements.productQuantityCart.value);
  });
} // Create a instance of Booking Model on placeOrderBtn Click


if (baseView.DOMElements.orderPlaceBtn) {
  baseView.DOMElements.orderPlaceBtn.addEventListener('click', function () {
    if (baseView.DOMElements.orderPlaceBtn.dataset.iscart === 'true') {
      authenticate.addProductToBooking(baseView.DOMElements.orderPlaceBtn.dataset.userid);
    } else if (baseView.DOMElements.orderPlaceBtn.dataset.iscart === 'false') {
      authenticate.addProductToBooking(baseView.DOMElements.orderPlaceBtn.dataset.userid, baseView.DOMElements.cartItems[0].dataset.productid);
    }
  });
...
if (baseView.DOMElements.proceedBtnChooseAddr) {
  baseView.DOMElements.proceedBtnChooseAddr.addEventListener('click', function () {
...
if (baseView.DOMElements.pincodeCheckBtn) {
  baseView.DOMElements.pincodeCheckBtn.addEventListener('click', baseView.checkDeliveryOnPincode);
} //## Validations
// Check whether password and confirmpassword are matching


if (baseView.DOMElements.confirmPassword) {
  baseView.DOMElements.confirmPassword.addEventListener('keyup', baseView.checkPasswordMatch);
  baseView.DOMElements.newPassword.addEventListener('change', baseView.checkPasswordMatch);
  baseView.DOMElements.newPassword.addEventListener('change', baseView.validatePasswordInput(baseView.DOMElements.newPassword));
} // Password Length should be minimum 6 characters


if (baseView.DOMElements.passwordCommonObj) {
  baseView.DOMElements.passwordCommonObj.addEventListener('keyup', baseView.validatePasswordInput(baseView.DOMElements.passwordCommonObj));
} // Onchaging the value of input, check that single input


if (baseView.DOMElements.inputCommonArr.length > 0) {
  baseView.DOMElements.inputCommonArr.forEach(function (el) {
